...
public class UserRegisterBindingModel {
    ...
    private static final int MAX_CONFIRM_PASSWORD_LENGTH = 20;
    private static final int MIN_CONFIRM_PASSWORD_LENGTH = 4;
    ...
    @NotEmpty
    @Size(min = MIN_CONFIRM_PASSWORD_LENGTH, max = MAX_CONFIRM_PASSWORD_LENGTH, message = CONFIRM_PASSWORD_MSG)
